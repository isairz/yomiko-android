...
class MangaListAdapter(private val retryCallback: () -> Unit) : PagedListAdapter<MangaInfo, RecyclerView.ViewHolder>(MangaDiffCallback) {

    private var networkState: NetworkState? = null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            R.layout.item_manga_row -> MangaListViewHolder.create(parent)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (getItemViewType(position)) {
            R.layout.item_manga_row -> (holder as MangaListViewHolder).bindTo(getItem(position))
    ...
    companion object {
        val MangaDiffCallback = object : DiffUtil.ItemCallback<MangaInfo>() {
